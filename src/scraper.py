...
from src.data import get_data, get_urls
...
async def get_listings(selector: str, links: list[str], page: Page) -> list[str]:
...
async def get_jobs() -> list[dict[str, str]]:
    ...
    Returns:
        list[dict[str, str]: A list of all companies with their available job postings
    """
